...
import ke.co.osl.umcollector.models.mappedBody
import retrofit2.Call
import retrofit2.Response

class MappedPoints: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mapped_points)
        ...
        back.setOnClickListener{
            startActivity(Intent(this@MappedPoints,Home::class.java))
        }
    ...
    private fun displayMappedList(offset: Int) {
        ...
        val apiInterface = ApiInterface.create().showMappedList(offset)
        apiInterface.enqueue(object : retrofit2.Callback<mappedBody> {
            override fun onResponse(call: Call<mappedBody>,response: Response<mappedBody>) {
                progress.visibility = View.GONE
                val responseBody = response.body()!!
                myAdapter = MyAdapter(baseContext, responseBody.data,offset)
            ...
            override fun onFailure(call: Call<mappedBody>, t: Throwable) {
                progress.visibility = View.GONE
