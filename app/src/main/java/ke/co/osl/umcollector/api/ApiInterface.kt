package ke.co.osl.umcollector.api
...
interface ApiInterface {
        ...
        companion object {
         ...
         var BASE_URL = "http://185.215.180.181:9034/api/"
//                var BASE_URL = "http://192.168.1.136:3002/"
        ...
        @POST("publicusers/register")
        fun registerUser(@Body regBody: RegBody) : Call<Message>
