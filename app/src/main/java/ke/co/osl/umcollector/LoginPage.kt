...
import ke.co.osl.umcollector.models.LoginBody
import ke.co.osl.umcollector.models.RecoverPasswordBody
...
//        Theme_Black_NoTitleBar_Fullscreen - style theme changed from...
    ...
    private fun postLoginDetails(){
        ...
        next.setOnClickListener {
            ...
            val apiInterface = ApiInterface.create().loginDataCollector(loginBody)
